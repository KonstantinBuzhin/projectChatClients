...
public class ClientRegisterController {
	...
	public void showConnect(ActionEvent event) {
		try {
			...
			dos.writeUTF(id);
			String clientCurrent;
			if (!dbClient.getUser(id).equals(id)) {
				System.out.println("creating...");
				dbClient.createClient(id);
				clientCurrent = id;
			} else {
				clientCurrent = dbClient.getUser(id);
			...
			if (currentLine.equals("You are already registered...!!!") || currentLine.equals(clientCurrent)) {
				Alert alert = new Alert(AlertType.INFORMATION);
				alert.setTitle("Test Connection");
				alert.setHeaderText(null);
